// PCH for C:\Program Files (x86)\UE_4.20\Engine\Source\Runtime\Engine\Public\EngineSharedPCH.h
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#include "C:\Program Files (x86)\UE_4.20\Engine\Source\Runtime\Engine\Public\EngineSharedPCH.h"
